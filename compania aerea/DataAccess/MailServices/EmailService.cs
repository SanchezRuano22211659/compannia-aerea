...
namespace DataAccess.MailServices
{
    public class EmailService
    {
        ...
        private readonly string Address = "carlos.mrz2023@gmail.com";//Establece la dirección del correo servidor remitente(Aquí coloque el correo electrónico responsable de enviar los correos electrónicos).
        private readonly string Password = "hpbm mqir ghkk jyrc";//Establece la contraseña del correo servidor remitente(Aquí coloque la contraseña del correo que estableciste en la linea anterior).
        private readonly string DisplayName = "QATAR AIRWAYS";//Establece el nombre para mostrar cuando se envia un mensaje de correo.
